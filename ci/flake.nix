{
  ...
  outputs = {
    ...
    in {
      ...
      apps.train-classifier = {
        type = "app";
        program = let
          wrapped = pkgs.writeShellScriptBin "train-classifier" ''
            set -euo pipefail
          ...
          '';
        in "${wrapped}/bin/train-classifier";
      };
      ...
      apps.commit-hash = {
        type = "app";
        program = let
          wrapped = pkgs.writeShellScriptBin "commit-hash" ''
            set -euo pipefail
