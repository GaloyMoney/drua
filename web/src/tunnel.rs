...
use galoy_agents_core::toolset::SearchableToolSet;
use galoy_agents_core::tunnel::{TunnelHandle, TunnelMessage, TunnelToolSet};
...
) -> Option<(String, Vec<galoy_agents_core::tunnel::RegisteredToolSet>)> {
