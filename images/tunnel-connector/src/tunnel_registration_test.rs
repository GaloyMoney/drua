...
async fn registers_reconciled_postgres_mcp_tools() -> anyhow::Result<()> {
    ...
    let cli = Cli {
        ...
        postgres_mcp_service_account_name: None,
        ...
        postgres_mcp_cloud_sql_proxy_image:
            crate::postgres_mcp::DEFAULT_POSTGRES_MCP_CLOUD_SQL_PROXY_IMAGE.to_string(),
        postgres_mcp_cloud_sql_proxy_image_pull_policy: "IfNotPresent".to_string(),
        postgres_mcp_runtime_cloud_sql_proxy_arg: None,
        postgres_mcp_datawarehouse_cloud_sql_proxy_arg: None,
