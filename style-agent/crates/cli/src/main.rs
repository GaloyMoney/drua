...
/// Style Agent - MCP server for code style suggestions
#[derive(Parser, Debug)]
#[command(name = "style-agent", about = "Code style search and suggestions")]
struct Cli {
    #[command(subcommand)]
    command: Command,
}
...
enum Command {
    ...
    Index {
        ...
        /// Database name override (defaults to "style-agent")
        #[arg(long)]
