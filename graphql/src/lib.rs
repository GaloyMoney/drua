...
impl Query {
    ...
    async fn me(&self, ctx: &Context<'_>) -> async_graphql::Result<UserType> {
        ...
        let user_id = auth.user_id().map_err(async_graphql::Error::new)?;
    ...
    #[instrument(name = "graphql.my_agents", skip_all)]
...
#[Object]
impl Mutation {
    #[instrument(name = "graphql.create_agent", skip_all)]
    ...
    #[instrument(name = "graphql.revoke_agent", skip_all)]
